...
*/			
			...
			if($myAdmin->conexion->insert('como_dice',$_POST['res'],'HTML')){
...
<script type="text/javascript">
	var data = Array();
	data[0] = Array('res[autor]','texto','"Autor"');
...
<table class="form" cellspacing="0">
	<tr>
		...
		<td><input type="text" maxlength="200" size="45" name="res[autor]" id="autor" /></td>
	</tr>
	<tr>
		<th><label for="res[texto]">Texto</label></th>
		<td>
			<textarea name="res[texto]" rows="6" cols="45"></textarea>		</td>
	</tr>
	<tr>
		<th><label for="res[autor]">Link</label></th>
		<td><input type="text" maxlength="200" size="45" name="res[link]" id="link" /></td>
	</tr>
	<tr>
...
<script type="text/javascript">
	var obj = document.getElementById('autor');
	obj.focus();
</script>
