...
*/			
	if(isset($_POST['r']['id']) && is_numeric($_POST['r']['id'])){
		...
		#print_r($_POST);
		if($myAdmin->conexion->update(PREFIJO.'grupo_flashban',$_POST['res'],"WHERE kid_grupo=$id",'HTML')){
...
$res = $myAdmin->conexion->fetch($myAdmin->conexion->query("SELECT * FROM ".PREFIJO."grupo_flashban WHERE kid_grupo='".$_GET['id']."'"));
$res = $res[0];
#print_r($res);
...
<table class="form" cellspacing="0">
	...
	<tr>
		<th></th>
		<td><a onclick="enviaGrupoAJAX('<?php echo WEB_PATH; ?>admin/adm.flashgroups.php')" class="btnForm">Aceptar</a><a onclick="ajax_getData('<?php echo WEB_PATH; ?>admin/adm.flashgroups.php','','groupContenedor','GET');" class="btnForm">Cancelar</a></td>
	</tr>
</table>
</form>
<hr />
