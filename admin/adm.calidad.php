...
if(		isset($_GET['new'])){ 		include_once("adm.$page.new.php");}
...
else if(isset($_GET['admin'])){ 	include_once("adm.$page.admin.php");}
else{
	...
	if($continuar){
		...
		$query = $myAdmin->conexion->query("SELECT * FROM ".PREFIJO."calidad_empresa ORDER BY orden ASC LIMIT ".$paginacion['LIMIT']);
	}
