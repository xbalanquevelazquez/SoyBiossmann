...
*/
	function dynCalendar()
	{
        ...
        */
		...
		this.objEle			= arguments[0];
		this.callbackFunc   = arguments[2] ? 'dynCalendar_Format'+arguments[2] : 'dynCalendar_Format1';
		this.imagesPath     = arguments[3] ? arguments[3] : 'img/calendar/';
		this.layerID        = arguments[4] ? arguments[4] : 'dynCalendar_layer_' + dynCalendar_layers.length;
		this.objName        = arguments[1] ? arguments[1] : 'calendario'+(dynCalendar_layers.length+1);
		//alert(this.layerID);
		this.offsetX        = 5;
		this.offsetY        = 5;
...
{	idx=0;
	...
	{	if(document.forms[idx].elements[ele])
		{ 	document.forms[idx].elements[ele].value=dd + '/' + mm + '/' + aa+' '+hh;
			break;
		} idx++;	
	}
}
